...
public class Register {
	...
	@When("^I provide below valid details$")
	public void i_provide_below_valid_details(DataTable dataTable) {
	...
	public void i_should_see_that_the_User_Account_has_successfully_created() {
		...
		Assert.assertTrue(Elements.isDisplayed(AccountSuccessPage.successMessgae));
	...
	@And("^I should see the error messages informing the User to fill manadatory fileds$")
	public void I_should_see_the_error_messages_informing_the_User_to_fill_manadatory_fileds() {
	...
	@And("^I subscribe to Newsletters$")
	public void i_subscribe_to_Newsletters()
	{
		Elements.click(RegisterPage.yesToNewsletter);
	}
	
	@And("^I provide the below duplicate details$")
	public void i_provide_the_below_duplicate_details(DataTable dataTable)
	{
			RegisterPage.enterAllDetails(dataTable,"duplicate");
		}
	
	@And("^I should see that user is restricted from creating duplicate account$")
	public void i_should_see_that_user_is_restricted_from_creating_duplicate_account()
		{	
			Elements.VerifyTextEquals(RegisterPage.mainWarning,"Warning:Email Address is already registered");
		}
	}
